%% This script loads and plots the monkey behavioral data and model fits of each of the 5 models. 
...
%% standard errors
    ...
    dataN_ste = nanstd(perfdata1,0,1);
    datadelta_ste = squeeze(nanstd(perfdata2,0,1));
    IL1_ste = std(IL1_all,0,1);
    IL2_ste = squeeze(std(IL2_all,0,1));
    EP1_ste = std(EP1_all,0,1);
    EP2_ste = squeeze(std(EP2_all,0,1));
    EPF1_ste = std(EPF1_all,0,1);
    EPF2_ste = squeeze(std(EPF2_all,0,1));
    VP1_ste = std(VP1_all,0,1);
    VP2_ste = squeeze(std(VP2_all,0,1));
    VPF1_ste = std(VPF1_all,0,1);
    VPF2_ste = squeeze(std(VPF2_all,0,1));
    pars_IL_ste = std(pars_IL_all,0,1);
    pars_EP_ste = std(pars_EP_all,0,1);
    pars_EPF_ste = std(pars_EPF_all,0,1);
    pars_VP_ste = std(pars_VP_all,0,1);
    pars_VPF_ste = std(pars_VPF_all,0,1);
    ...
    Rs_IL_ste = std(Rs_IL_all,0,1);
    Rs_EP_ste = std(Rs_EP_all,0,1);
    Rs_EPF_ste = std(Rs_EPF_all,0,1);
    Rs_VP_ste = std(Rs_VP_all,0,1);
    Rs_VPF_ste = std(Rs_VPF_all,0,1);
