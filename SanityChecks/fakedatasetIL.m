...
for i = 1:ndatasets
    ...
    switch modelfit
        case {'IL'}
            ...
            Kest(i) = K_estimate;
        case {'EP'}
            [perfmodel1_fitted, perfmodel_fitted, alpha_estimate, J1_estimate, temp] = EPmodelfitting_J(fakedataIL)
        case {'SR'}
            [perfmodel1_fitted, perfmodel_fitted, K_estimate, alpha_estimate, J1_estimate,temp] = SRmodelfitting_J(fakedataIL)
        case {'VP'}
            [perfmodel1_fitted, perfmodel_fitted,alpha_estimate,J_bar_estimate,tau_estimate,temp] = VPmodelfitting_J(fakedataIL)
    end
